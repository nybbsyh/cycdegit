        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${pageContext.request.contextPath }/back/main" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
            ...
            <div ><a href="${pageContext.request.contextPath }/common/appcheck">app审核</a></div>
            </div>
            <!-- /sidebar menu -->
